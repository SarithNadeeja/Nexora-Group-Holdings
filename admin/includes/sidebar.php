<aside style="background:#111827;color:#e5e7eb;padding:24px 16px;">
    <h2 style="font-size:1.05rem;margin-bottom:22px;">Nexora Admin</h2>
    <nav style="display:grid;gap:8px;">
        <a href="dashboard.php" style="color:#e5e7eb;padding:10px 12px;border-radius:8px;background:rgba(255,255,255,0.04);">Dashboard</a>
