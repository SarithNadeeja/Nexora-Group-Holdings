...
<main>
    ...
    <?php
    $bannerVideoPath = __DIR__ . '/assets/videos/banner.webm';
    $bannerPosterPath = __DIR__ . '/assets/images/hero-poster.jpg';
    $mobileBannerPath = __DIR__ . '/assets/images/mobilebanner.png';
    $hasBannerVideo = is_file($bannerVideoPath);
    $hasMobileBanner = is_file($mobileBannerPath);
    $bannerPosterUrl = is_file($bannerPosterPath) ? nexora_url('assets/images/hero-poster.jpg') : '';
    ?>
    <section class="hero-cinematic<?php echo $hasMobileBanner ? ' hero-cinematic--mobile-banner' : ''; ?>" id="homeHero">
        <?php if ($hasMobileBanner): ?>
        <div class="hero-mobile-banner" aria-hidden="true">
            <img src="<?php echo nexora_url('assets/images/mobilebanner.png'); ?>" alt="">
        </div>
        <?php endif; ?>
        <div class="hero-video-wrap" aria-hidden="true">
            ...
            <video class="hero-video" autoplay loop muted playsinline preload="metadata"<?php echo $bannerPosterUrl !== '' ? ' poster="' . htmlspecialchars($bannerPosterUrl, ENT_QUOTES, 'UTF-8') . '"' : ''; ?>>
                <source src="<?php echo nexora_url('assets/videos/banner.webm'); ?>" type="video/webm">
            </video>
            <?php endif; ?>
